...
function App() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'A real-time AI safety system for cyclists that uses computer vision to detect and track nearby vehicles and pedestrians, assess collision risks, and enhance situational awareness—like a virtual co-pilot in urban environments.',
      image: '/odc.jpg',
    ...
    {
      title: 'The 8-Puzzle',
      description: 'An AI-based solver for the 8-puzzle game using the A* search algorithm in Python. Tiles slide in a 3×3 grid to reach a goal state through optimal moves.',
      image: '/8puzzle.jpg',
    ...
    },
    {
      ...
      description: 'Built an AI expert system in Prolog and Python to help students in Taipei find reliable local recommendations. The system uses interactive questions to deliver personalized suggestions based on location and interests.',
      image: 'esd.jpg',
    ...
    },
    {
      ...
      description: 'Developed a 4x4 Tic Tac Toe AI using Minimax with alpha-beta pruning and iterative deepening. The agent competes against random and human players, optimizing moves through efficient game tree exploration.',
      image: 'tictactoe.jpg',
    ...
    {
      title: 'One Bank',
      description: 'One Bank is an AI-powered platform that recommends the best credit card for each transaction based on real-time merchant data and user reward preferences—maximizing cashback, miles, or points.',
      image: '/onebank.jpg',
    ...
    },    
    {
      ...
      description: 'Built an AI system for stock price prediction using LSTM and AutoML. The model analyzes historical data to forecast future trends and serves real-time predictions via a FastAPI backend.',
